...
class ViewModel {
    ...
    var titleText = ""
    var paragraphText = ""
    var selectedImagePlaygroundConceptType = ImagePlaygroundConceptType.text
    var sourceImage: UIImage?
    var shouldPresentImagePlayground = false
    var imagePlaygroundConcept: [ImagePlaygroundConcept] {
        switch selectedImagePlaygroundConceptType {
        case .text:
            return words.map { .text($0) }
        case .extract:
            return [.extracted(from: paragraphText, title: titleText)]
        }
    }
    
    var imagePlaygroundSourceImage: Image? {
